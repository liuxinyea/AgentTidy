...
//!
//! Absolute paths, completion timestamps, the `agent_running` flag and the
//! `platform` label are normalised to placeholders so a single golden set
//! covers macOS and Windows CI runners. Other fixture fields (cwd, session
